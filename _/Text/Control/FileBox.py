...
class FileBox(Frame):
	def __init__(self, master, controller=None, home='', darkmode=True, fileicon=False, color2='', neonmode=False):
		...
		data = data.replace(r'<Downstream>', Zeta.System.Path.Core().downstream)
...
class FilePanel(Zeta.Panel.Window):
	def __init__(self, mode='basic', color2='green', home='', *args, **kargs):
		Zeta.Panel.Window.__init__(self, mode=mode, color2=color2, *args, **kargs)
		FileBox(self.frame, home=home)
