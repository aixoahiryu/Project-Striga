...
class HackingMenu(Window):
	def __init__(self, *args, **kwargs):
		...
		self.imgintercept=Zeta.Image.Icon.Load(icon='interceptw', icontype='bw').image
		...
		self.imgexploit=Zeta.Image.Icon.Load(icon='exploitw', icontype='bw').image
		...
		Button(self.frame, text='', relief='flat', anchor='w', command=lambda: Zeta.System.OS.open(Zeta.System.Path.Core.X+r'/Void/Upload')).pack(side='top', fill='x')
