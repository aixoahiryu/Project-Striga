...
Button(frame3, text='√', bg=colorbg, fg=colorfg, command=lambda: goPath(r'D:\ZL-Core\Toolbar\_\√ Experiment')).grid(sticky='W', row=0, column=0)
Button(frame3, text='≡', bg=colorbg, fg=colorfg, command=lambda: goPath(r'D:\ZL-Core\Toolbar\_\≡ Read')).grid(sticky='W', row=0, column=1)
Button(frame3, text='ᐅ', bg=colorbg, fg=colorfg, command=lambda: goPath(r'D:\ZL-Core\Toolbar\_\▷ Play')).grid(sticky='W', row=0, column=2)
