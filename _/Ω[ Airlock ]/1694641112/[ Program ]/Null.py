...
btnF = Button(trayframe, text=' F ', relief='flat', background=colorbg, foreground=colorfg)
btnF.grid(column=0, row=0, sticky='NSW')
btnF.bind("<Button-3>", lambda e: (os.startfile(ZLCORE+r'\Toolbar\F'), toggle_sidebar()))
btnN = Button(trayframe, text=' N ', relief='flat', background=colorbg, foreground=colorfg)
btnN.grid(column=1, row=0, sticky='NSW')
btnN.bind("<Button-3>", lambda e: (os.startfile(ZLCORE+r'\Toolbar\N'), toggle_sidebar()))
btn_ = Button(trayframe, text=' _ ', relief='flat', background=colorbg, foreground=colorfg)
