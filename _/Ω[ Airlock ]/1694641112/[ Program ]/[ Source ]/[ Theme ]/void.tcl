# Ace Combat 7 https://www.gameuidatabase.com/gameData.php?id=167
# Crying suns https://www.gameuidatabase.com/gameData.php?id=409
package require Tk 8.6

namespace eval ttk::theme::void {

    variable version 1.0
    package provide ttk::theme::void $version
    variable colors
    array set colors {
        -fg             "#eeeeee"
        -bg             "#313131"
    ...
    LoadImages [file join [file dirname [info script]] void]

    # Settings
    ttk::style theme create void -parent default -settings {
        ttk::style configure . \
