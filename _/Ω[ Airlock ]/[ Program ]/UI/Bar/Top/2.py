...
Button(frame3, text='H', bg=colorbg, fg=colorfg, command=lambda: goPath(r'D:\ZL-Core\Note\Main\X220\ZLnote\2. Tech\Hacking')).grid(sticky='W', row=0, column=0)
Label(frame3, text='|', bg=colorbg, fg=colorfg).grid(sticky='W', row=0, column=1)
Button(frame3, text='E', bg=colorbg, fg=colorfg, command=lambda: goPath(r'D:\ZL-Core\Toolbar\N\Σ Entertainment')).grid(sticky='W', row=0, column=2)
Button(frame3, text='F', bg=colorbg, fg=colorfg, command=lambda: goPath(r'D:\ZL-Core\Toolbar\N\Σ Furry')).grid(sticky='W', row=0, column=3)
