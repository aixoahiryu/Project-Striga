# Nier:automata https://www.gameuidatabase.com/gameData.php?id=150
package require Tk 8.6

namespace eval ttk::theme::null {

    variable version 1.0
    package provide ttk::theme::null $version
    variable colors
    array set colors {
        -fg             "#313131"
        -bg             "#ffffff"
    ...
    LoadImages [file join [file dirname [info script]] null]

    # Settings
    ttk::style theme create null -parent default -settings {
        ttk::style configure . \
