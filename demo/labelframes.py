...
class LabelFramesDemo(ttk.Frame):
    ...
    def _create_widgets(self):
        if self.isapp:
            MsgPanel(self, ["Label frames are used to group related widgets together.\n",
                            "The 'label' may be either plain text or another widget.\n\n",
                            "Individual option states are controlled by the Option label widget"])
    ...
    def _create_option_pane(self, parent):
        ...
        self.cbOpt = ttk.Checkbutton(lf, text='Use this option', command=self._toggle_opt)
